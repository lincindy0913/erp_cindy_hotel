...
WATER_REGISTRY = {
    ...
    # ── 麗格（花蓮市商校街）72 戶 ──────────────────────────────────────────
    # Key = 正規化水號（站所9A+編號8碼+檢號1碼，去橫線、英數大寫；檢號為英文者保留）
    # 經 114/10 水費帳單彙總表 + 逐張帳單交叉驗證（序號 1–72，唯一無重號）。
    # 258號（序 1–40）
    "9A079510178": ("麗格", "商校街258號BF"),
    "9A079510272": ("麗格", "商校街258號1F"),
    "9A079510267": ("麗格", "商校街258號2F-1"),
    "9A07951043K": ("麗格", "商校街258號2F-2"),
    "9A079510728": ("麗格", "商校街258號2F-3"),
    "9A079510251": ("麗格", "商校街258號3F-1"),
    "9A079510361": ("麗格", "商校街258號3F-2"),
    "9A079510424": ("麗格", "商校街258號3F-3"),
    "9A079510356": ("麗格", "商校街258號3F-5"),
    "9A079510712": ("麗格", "商校街258號3F-6"),
    "9A079510707": ("麗格", "商校街258號3F-7"),
    "9A079510691": ("麗格", "商校街258號3F-8"),
    "9A079510246": ("麗格", "商校街258號4F-1"),
    "9A079510340": ("麗格", "商校街258號4F-2"),
    "9A079510419": ("麗格", "商校街258號4F-3"),
    "9A079510335": ("麗格", "商校街258號4F-5"),
    "9A079510686": ("麗格", "商校街258號4F-6"),
    "9A079510670": ("麗格", "商校街258號4F-7"),
    "9A079510665": ("麗格", "商校街258號4F-8"),
    "9A079510230": ("麗格", "商校街258號5F-1"),
    "9A07951032K": ("麗格", "商校街258號5F-2"),
    "9A079510403": ("麗格", "商校街258號5F-3"),
    "9A079510314": ("麗格", "商校街258號5F-5"),
    "9A07951065K": ("麗格", "商校街258號5F-6"),
    "9A079510644": ("麗格", "商校街258號5F-7"),
    "9A079510639": ("麗格", "商校街258號5F-8"),
    "9A079510225": ("麗格", "商校街258號6F-1"),
    "9A079510309": ("麗格", "商校街258號6F-2"),
    "9A079510398": ("麗格", "商校街258號6F-3"),
    "9A079510293": ("麗格", "商校街258號6F-5"),
    "9A079510623": ("麗格", "商校街258號6F-6"),
    "9A079510618": ("麗格", "商校街258號6F-7"),
    "9A079510602": ("麗格", "商校街258號6F-8"),
    "9A07951021K": ("麗格", "商校街258號7F-1"),
    "9A079510288": ("麗格", "商校街258號7F-2"),
    "9A079510382": ("麗格", "商校街258號7F-3"),
    "9A079510377": ("麗格", "商校街258號7F-4"),
    "9A079510597": ("麗格", "商校街258號7F-5"),
    "9A079510581": ("麗格", "商校街258號7F-6"),
    "9A079510576": ("麗格", "商校街258號7F-7"),
    # 260號（序 41–56）
    "9A079510162": ("麗格", "商校街260號2F-1"),
    "9A079510068": ("麗格", "商校街260號2F-2"),
    "9A079510157": ("麗格", "商校街260號3F-1"),
    "9A079510141": ("麗格", "商校街260號3F-2"),
    "9A079510052": ("麗格", "商校街260號3F-3"),
    "9A079510136": ("麗格", "商校街260號4F-1"),
    "9A079510120": ("麗格", "商校街260號4F-2"),
    "9A079510047": ("麗格", "商校街260號4F-3"),
    "9A079510115": ("麗格", "商校街260號5F-1"),
    "9A07951010K": ("麗格", "商校街260號5F-2"),
    "9A079510031": ("麗格", "商校街260號5F-3"),
    "9A079510094": ("麗格", "商校街260號6F-1"),
    "9A079510089": ("麗格", "商校街260號6F-2"),
    "9A079510026": ("麗格", "商校街260號6F-3"),
    "9A079510073": ("麗格", "商校街260號7F-1"),
    "9A079510010": ("麗格", "商校街260號7F-2"),
    # 262號（序 57–72）
    "9A079510838": ("麗格", "商校街262號BF"),
    "9A079510822": ("麗格", "商校街262號1F"),
    "9A079510817": ("麗格", "商校街262號2F"),
    "9A079510560": ("麗格", "商校街262號3F-1"),
    "9A079510555": ("麗格", "商校街262號3F-2"),
    "9A079510801": ("麗格", "商校街262號3F-3"),
    "9A079510796": ("麗格", "商校街262號3F-5"),
    "9A07951054K": ("麗格", "商校街262號4F-1"),
    "9A079510534": ("麗格", "商校街262號4F-2"),
    "9A079510780": ("麗格", "商校街262號4F-3"),
    "9A079510775": ("麗格", "商校街262號4F-5"),
    "9A079510529": ("麗格", "商校街262號5F-1"),
    "9A079510513": ("麗格", "商校街262號5F-2"),
    "9A07951076K": ("麗格", "商校街262號5F-3"),
    "9A079510754": ("麗格", "商校街262號5F-5"),
    "9A079510749": ("麗格", "商校街262號6F"),
}
...
def _columnar_tiers(text: str, target: int):
    """直欄版面反推三段度數：Vision 有時把整頁「標籤擠一區、數值擠另一區」，
    標籤與數值間隔過大，逐欄 regex 接不到值。此時用彙總表已知且可靠的「合計
    使用度數」(target) 當校驗，從「經常(尖峰)度數」標籤後收集整數序列
    （把與調整係數黏在一起的「7200.877」還原成 720、純小數如 0.877/2.0740 略過），
    回傳第一組「連續三個、相加 == target」的 (尖峰, 半尖峰, 離峰)。找不到回 None。"""
    if not target:
        return None
    lbl = re.search(r'經常\s*[(（]?\s*尖峰\s*[)）]?\s*度數', text)
    if not lbl:
        return None
    cand = []
    for tok in re.findall(r'\d[\d,]*\.\d+|\d[\d,]*', text[lbl.start():])[:40]:
        if '.' in tok:
            m = re.match(r'^([\d,]+)0\.\d+$', tok)   # 度數黏調整係數：「7200.877」→720
            if m:
                cand.append(int(m.group(1).replace(',', '')))
            # 否則為純小數（0.877 / 2.0740 …）→ 跳過
        else:
            cand.append(int(tok.replace(',', '')))
    for i in range(len(cand) - 2):
        a, b, c = cand[i], cand[i + 1], cand[i + 2]
        if a + b + c == target:
            return a, b, c
    return None
...
def parse_electricity_detail(text: str, page_num: int, backfill: dict = None,
    ...
    # 直欄 fallback：逐欄 regex 接不到值（三段全 0），或三段相加對不上彙總表
    # 合計度數時，用合計度數反推正確的尖/半/離（見 _columnar_tiers）。只在「對
    # 不上」時介入，已正確的筆不動。
    bf_usage = bf.get("usage") if bf else None
    if bf_usage and (peak + semi + off) != bf_usage:
        tiers3 = _columnar_tiers(text, bf_usage)
        if tiers3:
            peak, semi, off = tiers3

    # 使用度數: prefer summary backfill; else the sum of whichever tiers read
    usage = bf_usage if bf_usage else None
    if not usage:
        s = peak + semi + off
