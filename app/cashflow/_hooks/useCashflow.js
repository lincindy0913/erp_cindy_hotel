...
export const ACCOUNT_TYPES = ['現金', '銀行存款', '代墊款', '信用卡'];
export const TX_TYPES = ['收入', '支出', '移轉'];
export const TABS = [
...
export const PL_LEVEL1_OPTIONS = ['收入', '費用', '業外'];
export const PL_GROUP_SUGGESTIONS = {
  '收入': ['住宿收入', '餐飲收入', '其他營業收入'],
...
export function useCashflow() {
  ...
  return {
    ...
    // Shared data
    accounts, categories, transactions, suppliers, warehouses,
    loading, accountsError, transactionsError,
    accountingSubjects,
    // Account form
    ...
    // Forecast
    summaryData,
    forecastWarehouse, setForecastWarehouse,
    // Fetchers
    fetchAccounts, fetchTransactions, fetchReport, fetchSubjectQuery, fetchSummary,
    // Handlers
    handleCreateAccount, handleSetPrimaryAccount, handleDeleteAccount,
    handleCreateCategory, handleDeleteCategory, handleUpdateCategory,
    handleSeedCategories, handleBatchCategorize,
    handleCreateTransaction, handleDeleteTransaction, handleUpdateTransaction, handleReverseTransaction,
    // Helpers
    formatMoney, getAccountName, getSupplierName, getAccountsByType, getCategoriesForType,
  };
}
