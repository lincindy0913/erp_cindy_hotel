...
export default function SettingsPage() {
  ...
  function renderContent() {
    switch (activeSection) {
      case 'warehouses':
        return <WarehousesSection warehouseData={warehouseData} warehouseLoading={warehouseLoading} saving={saving} selectedBuildingForStorage={selectedBuildingForStorage} setSelectedBuildingForStorage={setSelectedBuildingForStorage} newWarehouse={newWarehouse} setNewWarehouse={setNewWarehouse} addStorageLocation={addStorageLocation} deleteStorageLocation={deleteStorageLocation} />;
      case 'departments':
        return <DepartmentsSection warehouseData={warehouseData} warehouseLoading={warehouseLoading} saving={saving} newBuilding={newBuilding} setNewBuilding={setNewBuilding} addBuilding={addBuilding} newDeptWarehouse={newDeptWarehouse} setNewDeptWarehouse={setNewDeptWarehouse} newDeptName={newDeptName} setNewDeptName={setNewDeptName} addDepartmentToWarehouse={addDepartmentToWarehouse} deleteWarehouse={deleteWarehouse} deleteDepartment={deleteDepartment} />;
      case 'master-data':
        return <MasterDataSection masterDataCounts={masterDataCounts} auditInfo={auditInfo} />;
      case 'finance':
        return <FinanceSection taxRate={taxRate} setTaxRate={setTaxRate} saving={saving} saveTaxRate={saveTaxRate} invoiceTitles={invoiceTitles} newInvoiceTitle={newInvoiceTitle} setNewInvoiceTitle={setNewInvoiceTitle} newInvoiceTaxId={newInvoiceTaxId} setNewInvoiceTaxId={setNewInvoiceTaxId} addInvoiceTitle={addInvoiceTitle} deleteInvoiceTitle={deleteInvoiceTitle} paymentMethods={paymentMethods} newPaymentMethod={newPaymentMethod} setNewPaymentMethod={setNewPaymentMethod} addPaymentMethod={addPaymentMethod} deletePaymentMethod={deletePaymentMethod} auditInfo={auditInfo} />;
      case 'pms-mapping':
        return <PmsMappingSection mappingRules={mappingRules} mappingSubTab={mappingSubTab} setMappingSubTab={setMappingSubTab} editingMappingId={editingMappingId} mappingEditForm={mappingEditForm} setMappingEditForm={setMappingEditForm} showAddMappingForm={showAddMappingForm} setShowAddMappingForm={setShowAddMappingForm} newMappingForm={newMappingForm} setNewMappingForm={setNewMappingForm} accountingSubjects={accountingSubjects} saving={saving} startEditMapping={startEditMapping} cancelEditMapping={cancelEditMapping} saveMappingEdit={saveMappingEdit} addMappingRule={addMappingRule} deleteMappingRule={deleteMappingRule} auditInfo={auditInfo} />;
      case 'expense-categories':
        return <ExpenseCategoriesSection expenseCategories={expenseCategories} categoryForm={categoryForm} setCategoryForm={setCategoryForm} editingCategoryId={editingCategoryId} saving={saving} saveExpenseCategory={saveExpenseCategory} editExpenseCategory={editExpenseCategory} cancelEditCategory={cancelEditCategory} deleteExpenseCategory={deleteExpenseCategory} auditInfo={auditInfo} />;
      case 'notifications':
