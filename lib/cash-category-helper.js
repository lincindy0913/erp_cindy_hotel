...
const SOURCE_TYPE_TO_SYSTEM_CODE = {
  ...
  rental_utility_income: 'RENTAL_INCOME',
  ...
  employee_advance_settle: 'MISC_EXPENSE',
  // Shareholder loan (boss private expenses on company credit card)
  shareholder_loan: 'MISC_EXPENSE',
  // Purchase allowance refund
  purchase_allowance: 'MISC_INCOME',
  // Reversal
  reversal: 'REVERSAL',
  // Reconciliation
