...
export const AUDIT_ACTIONS = {
  ...
  // 工程
  ENGINEERING_TERM_UPDATE:        'engineering_term.update',
  ENGINEERING_TERM_MANUAL_PAID:   'engineering_term.manual_paid_override',
  // 庫存異動
  INVENTORY_ADJUSTMENT_CREATE:    'inventory_adjustment.create',
  INVENTORY_TRANSFER_CREATE:      'inventory_transfer.create',
  INVENTORY_TRANSFER_UPDATE:      'inventory_transfer.update',
  INVENTORY_TRANSFER_DELETE:      'inventory_transfer.delete',
  INVENTORY_REQUISITION_CREATE:   'inventory_requisition.create',
  INVENTORY_REQUISITION_UPDATE:   'inventory_requisition.update',
  INVENTORY_REQUISITION_DELETE:   'inventory_requisition.delete',
  INVENTORY_STOCK_COUNT_CREATE:   'inventory_stock_count.create',
  INVENTORY_STOCK_COUNT_UPDATE:   'inventory_stock_count.update',
  INVENTORY_STOCK_COUNT_DELETE:   'inventory_stock_count.delete',
};
...
const ACTION_LEVEL_MAP = {
  [AUDIT_ACTIONS.ENGINEERING_TERM_MANUAL_PAID]: AUDIT_LEVELS.FINANCE,
  ...
  [AUDIT_ACTIONS.CHECK_UPDATE]: AUDIT_LEVELS.OPERATION,
  ...
  [AUDIT_ACTIONS.INVENTORY_ADJUSTMENT_CREATE]:  AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_TRANSFER_CREATE]:    AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_TRANSFER_UPDATE]:    AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_TRANSFER_DELETE]:    AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_REQUISITION_CREATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_REQUISITION_UPDATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_REQUISITION_DELETE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_STOCK_COUNT_CREATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_STOCK_COUNT_UPDATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.INVENTORY_STOCK_COUNT_DELETE]: AUDIT_LEVELS.OPERATION,
};
...
export const AUDIT_ACTION_LABELS = {
  ...
  [AUDIT_ACTIONS.CHECK_UPDATE]: '修改支票',
