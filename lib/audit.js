...
export const AUDIT_ACTIONS = {
  ...
  ASSET_DISPOSAL_CREATE: 'asset_disposal.create',
  ASSET_DISPOSAL_UPDATE: 'asset_disposal.update',
  ASSET_DISPOSAL_DELETE: 'asset_disposal.delete',
  // 月結
  ...
  // 租屋
  RENTAL_PROPERTY_CREATE: 'rental_property.create',
  RENTAL_PROPERTY_UPDATE: 'rental_property.update',
  RENTAL_PROPERTY_DELETE: 'rental_property.delete',
  ...
  RENTAL_INCOME_CREATE: 'rental_income.create',
  RENTAL_INCOME_UPDATE: 'rental_income.update',
  RENTAL_INCOME_DELETE: 'rental_income.delete',
  PROPERTY_TAX_CREATE: 'property_tax.create',
  PROPERTY_TAX_UPDATE: 'property_tax.update',
  PROPERTY_TAX_DELETE: 'property_tax.delete',
  PROPERTY_TAX_PAY: 'property_tax.pay',
...
const ACTION_LEVEL_MAP = {
  ...
  [AUDIT_ACTIONS.RENTAL_INCOME_CREATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.RENTAL_INCOME_DELETE]: AUDIT_LEVELS.FINANCE,
  [AUDIT_ACTIONS.PROPERTY_TAX_CREATE]: AUDIT_LEVELS.FINANCE,
  [AUDIT_ACTIONS.PROPERTY_TAX_UPDATE]: AUDIT_LEVELS.FINANCE,
  [AUDIT_ACTIONS.PROPERTY_TAX_DELETE]: AUDIT_LEVELS.FINANCE,
  [AUDIT_ACTIONS.PROPERTY_TAX_PAY]:    AUDIT_LEVELS.FINANCE,
  ...
  [AUDIT_ACTIONS.ASSET_DISPOSAL_CREATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.ASSET_DISPOSAL_UPDATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.ASSET_DISPOSAL_DELETE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.CASH_ACCOUNT_DELETE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.SUPPLIER_UPDATE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.SUPPLIER_DELETE]: AUDIT_LEVELS.OPERATION,
  [AUDIT_ACTIONS.SUPPLIER_DEACTIVATE]: AUDIT_LEVELS.OPERATION,
...
export const AUDIT_ACTION_LABELS = {
  ...
  [AUDIT_ACTIONS.RENTAL_INCOME_CREATE]: '建立收款紀錄',
  [AUDIT_ACTIONS.RENTAL_INCOME_UPDATE]: '修改租金收入',
  [AUDIT_ACTIONS.RENTAL_INCOME_DELETE]: '作廢租金收入',
  [AUDIT_ACTIONS.PROPERTY_TAX_CREATE]: '建立稅款',
  [AUDIT_ACTIONS.PROPERTY_TAX_UPDATE]: '修改稅款',
  [AUDIT_ACTIONS.PROPERTY_TAX_DELETE]: '刪除稅款',
  [AUDIT_ACTIONS.PROPERTY_TAX_PAY]:    '繳納稅款',
  ...
  [AUDIT_ACTIONS.ASSET_DISPOSAL_CREATE]: '建立資產處分記錄',
  [AUDIT_ACTIONS.ASSET_DISPOSAL_UPDATE]: '修改資產處分記錄',
  [AUDIT_ACTIONS.ASSET_DISPOSAL_DELETE]: '刪除資產處分記錄',
  [AUDIT_ACTIONS.CASH_ACCOUNT_DELETE]: '刪除現金帳戶',
  [AUDIT_ACTIONS.SUPPLIER_UPDATE]: '修改廠商',
  [AUDIT_ACTIONS.SUPPLIER_DELETE]: '刪除廠商',
  [AUDIT_ACTIONS.SUPPLIER_DEACTIVATE]: '停用廠商',
